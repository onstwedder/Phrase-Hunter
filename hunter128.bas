...
699 RETURN 
700 REM SUCCESS 
710 PRINT:PRINT "*** SUCCESS - MATCH FOUND! ***" 
720 PRINT ">>> SEED";R;"AT POSITION";Y 
730 PRINT ">>> USING FORMULA X=RND(1)*";HI-LO+1;"+";LO 
735 PRINT:PRINT "CREATE BASIC LISTING?" 
740 GETKEY A$:IF A$="Y" THEN 800:ELSE END 
800 REM GENERATE BASIC 
810 PRINT:PRINT 
820 PRINT "10 X=RND(-";R;"):PRINT" 
830 PRINT "20 FOR I=1 TO";Y-1;":X=RND(1):NEXT" 
